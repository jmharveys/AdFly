					...
					<div style="z-index:0;overflow:hidden;width: 480px; height: 325px;position:absolute;">
						<div class='gallery'>
							<div class='scroller' style="width: 1920px;">
								<div>
									<div style='width: 480px; height: 247px; background-image: url("public/images/demo/mexique1.jpg");'></div>
								</div>
								<div>
									<div style='width: 480px; height: 247px; background-image: url("public/images/demo/mexique2.jpg");'></div>
								</div>	
								<div>
									<div style='width: 480px; height: 247px; background-image: url("public/images/demo/mexique3.jpg");'></div>
								</div>	
								<div>
									<div style='width: 480px; height: 247px; background-image: url("public/images/demo/mexique4.jpg");'></div>
								</div>			
							</div>
