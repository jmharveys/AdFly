...
<head>
	<meta charset="utf-8">
	<title>1/8 H galerie avec une offre | AdFly </title>
					...
					<div class="wrapper">
						...
						<div class='gallery'>
							<div class='scroller' style="width: 960px;">
								<div>
									<div style="background: url('<?= URL ?>public/images/demo/barcelo1.jpg'); width:328px; height:152px;display:table-cell;"></div>
								...
								<div>
									<div style="background: url('<?= URL ?>public/images/demo/barcelo2.jpg'); width:328px; height:152px;display:table-cell;"></div>
									<div class="description">
										<div>
